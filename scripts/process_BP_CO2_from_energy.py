...
if __name__ == '__main__':
    ...
    sheet_name = 'CO2 Emissions from Energy'
    units = 'Million tonnes of carbon dioxide'
    ...
    df_out['id'] = df_out.apply(
        lambda row: f"BP_review2022:emissions:{row['actor_id']}:{row['year']}", axis=1)
    ...
    # convert to csv
    df_out.to_csv(f'{outputDir}/BP_review_2022_CO2_from_energy.csv', index=False)